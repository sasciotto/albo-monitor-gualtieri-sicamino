...
def telegram_destination_id() -> str:
    """Restituisce l'identificativo del destinatario Telegram.

    La variabile ALBO_TELEGRAM_CHAT_ID è mantenuta come compatibilità
    con configurazioni precedenti.
    """
    return env_str("ALBO_TELEGRAM_DESTINATION_ID") or env_str("ALBO_TELEGRAM_CHAT_ID")
